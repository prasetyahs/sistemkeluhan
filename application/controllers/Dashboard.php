...
class Dashboard extends CI_Controller
{
    ...
    public function dataKeluhan()
    {
        ...
        foreach ($category as  $value) {
            $newData =  $this->mreport->getReportCountByCategory($value['id_jnskeluhan'], "id_jnskeluhan") / $this->mreport->getCategoryReportCount();
            array_push($result, $newData);
            $this->mreport->updateValueAlternatif(['nilai_alternatif' => $newData], ['id_jnskeluhan' => $value['id_jnskeluhan']]);
        }
    ...
    public function dataPengecekan()
    {
        ...
        $limit_page = 3;
        $page = ($this->uri->segment(3)) ? ($this->uri->segment(3) - 1) : 0;
        $data['results'] = $this->mreport->getCheckingReport($limit_page, $page * $limit_page);
